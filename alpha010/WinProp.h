...
namespace ss
{
	static	char const constexpr	*title_win	=	"the-base";
	static	size_t	constexpr		width_win	=	350;
	static	size_t	constexpr		height_win	=	500;
	static	size_t	constexpr		x_win		=	1920-350-50;
	static	size_t	constexpr		y_win		=	1080-500-40;
